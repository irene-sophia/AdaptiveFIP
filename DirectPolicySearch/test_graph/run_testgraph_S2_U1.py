...
from fugitive_interception_model_S2_U1 import fugitive_interception_model
    ...
    for seed in range(10):
        ...
        convergence_metrics = [
            ArchiveLogger(
                ...
                base_filename=f"archives_S2_U1_{graph_type}_seed{seed}.tar.gz"
            ),
        ...
        convergence = ArchiveLogger.load_archives(f"./results/archives_S2_U1_{graph_type}_seed{seed}.tar.gz")
        # print(results)
        ...
        convergence_df.to_csv(f'./results/archives_S{2}_U{1}_{graph_type}_seed{seed}.csv')
        ...
        #
        # policy = [Policy(name=f'DPS_solution_{idx}', c1=row['c1'], c2=row['c2'], r1=row['r1'], r2=row['r2'], w1=row['w1'])
